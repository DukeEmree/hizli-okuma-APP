...
import { yellow, yellowDark, green, greenDark } from '@tamagui/colors'
...
const darkPalette = ['hsla(200, 15%, 2%, 1)', 'hsla(200, 15%, 8%, 1)', 'hsla(200, 15%, 11%, 1)', 'hsla(200, 15%, 18%, 1)', 'hsla(200, 15%, 24%, 1)', 'hsla(200, 15%, 30%, 1)', 'hsla(200, 15%, 36%, 1)', 'hsla(200, 15%, 41%, 1)', 'hsla(200, 15%, 47%, 1)', 'hsla(200, 15%, 53%, 1)', 'hsla(200, 15%, 59%, 1)', 'hsla(200, 15%, 91%, 1)']
const lightPalette = ['hsla(200, 15%, 100%, 1)', 'hsla(200, 15%, 96%, 1)', 'hsla(200, 15%, 93%, 1)', 'hsla(200, 15%, 89%, 1)', 'hsla(200, 15%, 82%, 1)', 'hsla(200, 15%, 75%, 1)', 'hsla(200, 15%, 68%, 1)', 'hsla(200, 15%, 61%, 1)', 'hsla(200, 15%, 54%, 1)', 'hsla(200, 15%, 47%, 1)', 'hsla(200, 15%, 40%, 1)', 'hsla(200, 15%, 8%, 1)']
...
const emberLight = {
  orange1: "hsl(33, 62%, 90%)", orange2: "hsl(33, 62%, 87%)", orange3: "hsl(33, 62%, 83%)",
  orange4: "hsl(33, 62%, 76%)", orange5: "hsl(33, 62%, 71%)", orange6: "hsl(33, 62%, 66%)",
  orange7: "hsl(33, 62%, 62%)", orange8: "hsl(33, 62%, 54%)", orange9: "hsl(33, 62%, 44%)",
  orange10: "hsl(33, 62%, 38%)", orange11: "hsl(33, 62%, 31%)", orange12: "hsl(33, 62%, 14%)",
}
const emberDark = {
  orange1: "hsl(37, 72%, 11%)", orange2: "hsl(37, 72%, 12%)", orange3: "hsl(37, 72%, 16%)",
  orange4: "hsl(37, 72%, 17%)", orange5: "hsl(37, 72%, 20%)", orange6: "hsl(37, 72%, 26%)",
  orange7: "hsl(37, 72%, 34%)", orange8: "hsl(37, 72%, 44%)", orange9: "hsl(37, 72%, 56%)",
  orange10: "hsl(37, 72%, 60%)", orange11: "hsl(37, 72%, 71%)", orange12: "hsl(37, 72%, 92%)",
}
const alertLight = {
  red1: "hsl(7, 55%, 92%)", red2: "hsl(7, 55%, 91%)", red3: "hsl(7, 55%, 88%)",
  red4: "hsl(7, 55%, 86%)", red5: "hsl(7, 55%, 83%)", red6: "hsl(7, 55%, 79%)",
  red7: "hsl(7, 55%, 74%)", red8: "hsl(7, 55%, 67%)", red9: "hsl(7, 55%, 52%)",
  red10: "hsl(7, 55%, 48%)", red11: "hsl(7, 55%, 42%)", red12: "hsl(7, 55%, 17%)",
}
const alertDark = {
  red1: "hsl(5, 71%, 8%)", red2: "hsl(5, 71%, 9%)", red3: "hsl(5, 71%, 14%)",
  red4: "hsl(5, 71%, 18%)", red5: "hsl(5, 71%, 23%)", red6: "hsl(5, 71%, 29%)",
  red7: "hsl(5, 71%, 37%)", red8: "hsl(5, 71%, 48%)", red9: "hsl(5, 71%, 58%)",
  red10: "hsl(5, 71%, 64%)", red11: "hsl(5, 71%, 78%)", red12: "hsl(5, 71%, 90%)",
}
