...
const accentLight = {
  "accent1": "hsla(120, 50%, 43%, 1)",
  "accent2": "hsla(120, 50%, 45%, 1)",
  "accent3": "hsla(120, 50%, 48%, 1)",
  "accent4": "hsla(120, 50%, 50%, 1)",
  "accent5": "hsla(120, 50%, 53%, 1)",
  "accent6": "hsla(120, 50%, 55%, 1)",
  "accent7": "hsla(120, 50%, 58%, 1)",
  "accent8": "hsla(120, 50%, 60%, 1)",
  "accent9": "hsla(120, 50%, 63%, 1)",
  "accent10": "hsla(120, 50%, 65%, 1)",
  "accent11": "hsla(250, 50%, 95%, 1)",
  "accent12": "hsla(250, 50%, 95%, 1)"
}

const accentDark = {
  "accent1": "hsla(120, 50%, 35%, 1)",
  "accent2": "hsla(120, 50%, 38%, 1)",
  "accent3": "hsla(120, 50%, 41%, 1)",
  "accent4": "hsla(120, 50%, 43%, 1)",
  "accent5": "hsla(120, 50%, 46%, 1)",
  "accent6": "hsla(120, 50%, 49%, 1)",
  "accent7": "hsla(120, 50%, 52%, 1)",
  "accent8": "hsla(120, 50%, 54%, 1)",
  "accent9": "hsla(120, 50%, 57%, 1)",
  "accent10": "hsla(120, 50%, 60%, 1)",
