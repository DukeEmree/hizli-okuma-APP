    ...
    >
      ...
      <Sheet.Frame padding="$5" gap="$4" backgroundColor="$background">
        <YStack gap="$2" marginBottom="$4">
          ...
          <Text color="$color11" textAlign="center" fontSize={16}>
        ...
        <YStack gap="$3" marginTop="auto">
          <AppButton size="$5" onPress={handleLogin} theme="active">
            Giriş Yap / Kayıt Ol
          </AppButton>
          <AppButton size="$5" variant="outline" onPress={() => onOpenChange(false)}>
